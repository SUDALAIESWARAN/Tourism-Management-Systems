...
CREATE TABLE `booking` (
  ...
  `ffdate` varchar(20) NOT NULL,
  `ftdate` varchar(20) NOT NULL
...
(1, 'sudalai', 'sudalaieswaran2005@gmail.com', 9087859469, 'Mandya'),
(2, 'kamesh', 'kamesh2004@gmai.com', 9344693945, 'Manglore'),
(3, 'krishna', 'krishna2005@gmail.com', 9025008779, 'Mysore');
